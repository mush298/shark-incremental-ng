...
LANGUAGES.EN = {
    ...
    text: {
        ...
        'black_hole-name': "Black Hole Shards",
        'black_hole-costName': toTextStyle('Black Hole','black_hole') + ' Shards',
        ...
        'curr-top-3-req': x => `Reach <b>${format(x)}</b> ${toTextStyle('Magmatic','core')} Fragments`, 
        'curr-top-3-reset': (x,next) => `Go Singularity for <b>${format(x,0)}</b> ${toTextStyle('Black Hole','black_hole')} Shards`,
        ...
        'tab-black_hole': toTextStyle('Singularity','black_hole'),
        'tab-black_hole-reactor': toTextStyle('Black Hole','black_hole') + " Reactor",
        ...
        'su-b1-req': 'Rehehehehehehehe!',
        'su-b1-name': 'Black Hole Booster',
        'su-b1-desc': `Increases ${toTextStyle('Black Hole','black_hole')} size gain by <b>×lg(${toTextStyle('Black Hole','black_hole')} size)</b> per level.`,
        ...
        'research-b1-name': "Evolution Keeper I",
        'research-b1-desc': `Cultivation and the Evolution Tree are kept when going Singularity`,

        'research-b2-name': "Evolution Keeper II",
        'research-b2-desc': `Core stuff is kept when going Singularity, as well as everything else`,
        ...
        'forge': {
            'anvil': ['Anvil Tier','Unlocks some new forge upgrades.'],
            ...
            'tree': ['Extraordinary Tree',`Unlocks a new row of the ${toTextStyle('Evolution','humanoid')} tree.`],
            'adv_research': ['Advanced Research',`Unlocks some new research.`],
            'auto': ['Advanced Automation',`Unlocks some new automation.`],
            'shark': ['Distant Shark Level',`Delays the third scaling of the ${toTextStyle('Shark','shark')} Level.`],
            ...
            'black_hole': ['Quantumized Black Hole',`Unlocks new Black Hole effects.`],
        },
        ...
        'black_hole-size': x => `Your black hole's size is <h2><b>${x}</b> g</h2>`,
        'black_hole-bonus0': x => `^${x} ${toTextStyle('Fish','fish')}`,
        'black_hole-bonus1': x => `^${x} ${toTextStyle('Prestige','prestige')} Shards`,
        'black_hole-bonus2': x => `^${x} ${toTextStyle("Magmatic",'core')} Fragments`,
        'black_hole-bonus3': x => `${formatMult(x)} ${toTextStyle('Humanoid','humanoid')} Sharks`,
        'black_hole-bonus4': x => `${formatMult(x)} Forging Speed`,
        'black_hole-bonus5': x => `${formatMult(x)} ${toTextStyle('Black Hole','black_hole')} Shards`,
        ...
        'progress-16-text': r => `Reach ${format(r)} total ${toTextStyle('Magmatic','core')} fragments`, 
        get 'progress-16-cond-text'() { return `Go ${toTextStyle('Singularity','black_hole')}` },

        'progress-17-text': r => `Reach ${format(r)} total ${toTextStyle('Black Hole','black_hole')} Shards`, 
        ...
        get 'reset-black_hole-message'() {
            let b = toTextStyle('Black Hole', 'black_hole'),  s = toTextStyle('Singularity', 'black_hole'), e = toTextStyle('Evolution','humanoid'), c = toTextStyle('Core','core'), m = toTextStyle('Magmatic','core'), p = toTextStyle('Prestige','prestige')
            return `
            <h3>The ${s}</h3><br>
            <subtitle>“Going ${s} will reward you with ${b} Shards, However with a cost of everything you had up to this point.”</subtitle>
            The ${s} is the fourth reset layer. Going ${s} will reset everything that ${e} does, and all ${e} content, and some ${toTextStyle('Research','prestige')} for ${b} Shards.
            It also unlocks the ${b} Reactor<br>
            <img src="textures/Evolution.png"><br>
            Are you sure you want to go ${s}?
            `
        },
        ...
        'popup-desc' : {
            ...
            wipe: `Are you sure you want to wipe your save? To wipe, type "<span class="free-select">Ratatata don't pee on the floor, use the commodore!</span>"`,
        ...
        'confirm-black_hole': "Go Singularity",
    },
}
