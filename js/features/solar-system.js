const ROCKET_PARTS = {
    ...
    costs: [
        ...
        [()=>player.singularity.dm,'dark-matter-costName',x=>hasUMilestone(7) ? x.sumBase(1.001).pow_base(100).mul(1e12) : x.sumBase(1.1).pow_base(100).mul(1e12),x=>hasUMilestone(7) ? x.div(1e12).log(100).sumBase(1.001,true).add(1).floor() : x.div(1e12).log(100).sumBase(1.1,true).add(1).floor()],
    ],
    buy(i) {
