const SHARK = {
    ...
    rank: {
        ...
        bonuses: {
            ...
            dilated: [()=>player.shark_rank.gte(11000),l=>E(0).add(l.pow(2)),E(1)],
        },
    },
}
...
const SHARK_UPGRADES = {
    ...
    d1: {
        req: ()=>hasSMilestone(16),

        cost: l => Decimal.pow(1000,l).mul(1),
        bulk: x => x.div(1).log(1000).floor().add(1),

        curr: "dark-matter",

        effect: l=>Decimal.mul(0.1, l).add(1),
