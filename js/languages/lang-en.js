...
LANGUAGES.EN = {
    ...
    text: {
        ...
        'dark-evolution-tree-ctn': [
            ["Boosted Column 1", x=>`The first column of ${toTextStyle("Remnant",'black-hole')} upgrades are boosted.`],
            ["Boosted Column 2", x=>`The second column of ${toTextStyle("Remnant",'black-hole')} upgrades are boosted.`],
            ["Boosted Column 3", x=>`The third column of ${toTextStyle("Remnant",'black-hole')} upgrades are boosted.`],
            ["Boosted Column 4", x=>`The fourth column of ${toTextStyle("Remnant",'black-hole')} upgrades are boosted.`],
        ],
