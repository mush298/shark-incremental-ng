const CURRENCIES = {
    fish: {
        ...
        get gain() {
            ...
            if (hasElement(8)) x = expPow(x, elemEffect(8))
    ...
    prestige: {
        ...
        get gain() {
            ...
            if (hasElement(7)) x = expPow(x, elemEffect(7))
            x = expPow(x,tmp.bh_reduction)
    ...
    core: {
        ...
        get gain() {
            ...
            if (hasElement(4)) x = expPow(x, elemEffect(4))
    ...
    remnants: {
        ...
        get gain() {
            ...
            if (hasElement(0)) x = x.pow(elemEffect(0))
    ...
    'dark-matter': {
        ...
        get gain() {
            ...
            if (hasElement(1)) x = x.pow(elemEffect(1))
    ...
    quarks: {
        get require() { return E('0') },

        get amount() { return player.singularity.quarks},
        set amount(v) { player.singularity.quarks = v.max(0) },

        get total() { return player.singularity.total_quarks },
        set total(v) { player.singularity.total_quarks = v.max(0) },
        ...
        get gain() {
            ...
            if (hasElement(2)) x = x.pow(elemEffect(2))

                if (hasElement(13)) x = x.pow(1.25)
                    if (hasElement(15)) x = x.pow(1.25)
                        if (hasElement(18)) x = x.pow(elemEffect(18))

            return x
        },

        get passive() { return hasSMilestone(11) },
    },
}
