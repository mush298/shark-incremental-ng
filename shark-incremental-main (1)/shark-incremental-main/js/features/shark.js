...
const SHARK_UPGRADES = {
    ...
    b1: {
        ...
        cost: l => Decimal.pow('1e100',Decimal.pow(10000, l)),
        bulk: x => x.div('1e100').log(Decimal.div(10000,x)).floor().add(1),

        curr: "fish",

        effect: l=>Decimal.pow(player.black_hole.size.log10(), l),
        effDesc: x=>formatMult(x),
    },
}
